...
class Parser(sly.Parser):
    ...
    precedence = (
        ('right', EQ_PLUS, EQ_MINUS, EQ_TIMES, EQ_DIVIDE, EQ_MODULE, ASSIGN),     # menor precedencia
        ('left', OR),
        ('left', AND),
        ('left', EQ, NE),
        ('left', LT, LE, GT, GE),
...
#########################################
    ...
    @_("expression ASSIGN expression",
        "expression EQ_PLUS expression",
        "expression EQ_MINUS expression",
        "expression EQ_TIMES expression",
        "expression EQ_DIVIDE expression",
        "expression EQ_MODULE expression")
